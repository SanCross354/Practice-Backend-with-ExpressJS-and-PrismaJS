...
const update = async (user, request) => {
    ...
    if (totalContactInDatabase !== 1) { //It means there's no contact data (Zero contact)
        throw new ResponseError(404, "Contact is not found")
    }

    return prismaClient.contact.update({
        where: {
            id: contact.id //Not need username because username already validated in totalContactInDatabase
        },
        data: {
